...
<ul>
	<li><a href="paramTest.do?no=2&title=제목2">전달 값 체크(변수명 매칭)</a></li>
	<li><a href="paramTest1.do?no=1&title=제목">전달 값 체크(쿼리 스트링)</a></li>
	<li><a href="paramTest2.do?no=1&title=제목">전달 값 체크(객체)</a></li>
	<li><a href="returnParam.do?no=50&title=제목 500">리턴 값 확인 (모델)</a></li>
	<li><a href="returnParam1.do?no=90&title=제목 900">리턴 값 확인 (모델-뷰)</a></li>
	<li>
		<form action="/firstSpring/printNotice.do" method="post">
		
			글 번호 : <input type="number" name="no" value="0" > <br>
