...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/common/common.css?v=12" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/common/common_sp.css?v=9" />
...
<link rel='stylesheet' type='text/css' href='<%=request.getContextPath()%>/static/css/search.css?v=9'>
