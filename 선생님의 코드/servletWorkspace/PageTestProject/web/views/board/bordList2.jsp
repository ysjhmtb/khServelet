...
<!-- 	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/common/common.js?v=1"></script>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/common/jquery.rwdImageMaps.js"></script>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bower_components/jquery-address/src/jquery.address.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bower_components/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bower_components/jquery-ui/ui/i18n/datepicker-ko.js"></script>
    -->
