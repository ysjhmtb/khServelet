 ...
 * Generated at: 2018-06-14 12:13:27 UTC
...
public final class boardUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/header.jsp", Long.valueOf(1528791730000L));
...
if(member == null){ 
      ...
      out.write("\t<h2 align=\"center\">게시글 수정</h2>\n");
      out.write("\t<div class=\"tableArea\" align=\"center\">\n");
      out.write("\t\t<form method=\"post\" action=\"/mwp/updateBoard.do\" enctype=\"multipart/form-data\">\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"title\" size=\"33\" value=\"");
      out.print(board.getTitle());
      out.write("\"/>\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<!-- file - value 속성은 사용자 피씨의 자원에\n");
      out.write("\t\t\t\t\t\t\t 직접 접근 한다는 것이기 때문에 보안에 취약하다 -->\n");
      out.write("<!-- \t\t\t\t<tr> -->\n");
...
if(null != board.getAttachFile()){ 
      ...
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td colspan=\"4\">\n");
      out.write("\t\t\t\t\t\t<textarea name=\"content\" cols=\"40\" rows=\"15\">");
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"취소\" onclick=\"noticePage();\"/>\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"삭제\" onclick=\"deleteNotice();\"/>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</form>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
