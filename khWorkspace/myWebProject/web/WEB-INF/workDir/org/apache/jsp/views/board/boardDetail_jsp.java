 ...
 * Generated at: 2018-06-18 12:08:22 UTC
...
return;
	...
	ArrayList<CommentVo> cList = (ArrayList<CommentVo>)request.getAttribute("cList");
      ...
      out.write("\t\t// 댓글 수정 -> 댓글 번호, 댓글 내용이 필요.\n");
      ...
      out.write("\t}\n");
      out.write("\t\n");
      out.write("\tfunction deleteComment(cno, bno){\n");
      out.write("\t\tvar cno = cno;\n");
      out.write("\t\tvar bno = bno;\n");
      out.write("\t\tlocation.href = \"deleteComment.do?cno=\" + cno + \"&bno=\" + bno;\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("\t\n");
      out.write("</script>\n");
...
if(member.getUserId().equals(c.getWriter())){ 
      ...
      out.print(board.getNo());
      out.write(");\"/>\n");
      out.write("\t\t\t\t\t<input type=\"button\" class=\"updateBtn\" style=\"display:none;\" \n");
      out.write("\t\t\t\t\t\tvalue=\"작성 완료\" onclick=\"updateComment(this,");
      out.print(c.getCno());
      out.write(");\"/>\n");
      out.write("\t\t\t\t\t<input type=\"button\" class=\"cancelBtn\" style=\"display:none;\" value=\"취소\" \n");
      out.write("\t\t\t\t\t\tonclick=\"updateCommentForm(this, false);\"/>\n");
      out.write("\t\t\t\t");
} 
      out.write("\n");
      out.write("\t\t\t\t</td>\n");
